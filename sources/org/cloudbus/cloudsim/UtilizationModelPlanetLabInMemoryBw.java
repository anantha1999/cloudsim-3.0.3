 ...
 */
public class UtilizationModelPlanetLabInMemoryBw implements UtilizationModel {
	 ...
	 */
	public UtilizationModelPlanetLabInMemoryBw(String inputPath, double schedulingInterval)
	 ...
	 * @throws IOException Signals that an I/O exception has occurred.
	 */
	public UtilizationModelPlanetLabInMemoryBw(String inputPath, double schedulingInterval, int dataSamples)
			throws NumberFormatException,
			IOException {
		setSchedulingInterval(schedulingInterval);
