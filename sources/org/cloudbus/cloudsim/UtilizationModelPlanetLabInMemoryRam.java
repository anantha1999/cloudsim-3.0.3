 ...
 */
public class UtilizationModelPlanetLabInMemoryRam implements UtilizationModel {
	 ...
	 */
	public UtilizationModelPlanetLabInMemoryRam(String inputPath, double schedulingInterval)
	 ...
	 * @throws IOException Signals that an I/O exception has occurred.
	 */
	public UtilizationModelPlanetLabInMemoryRam(String inputPath, double schedulingInterval, int dataSamples)
			throws NumberFormatException,
			IOException {
		setSchedulingInterval(schedulingInterval);
