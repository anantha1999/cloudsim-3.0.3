...
public class WorkloadStoragePlanetLabWrite implements WorkloadStorage {
	 ...
	 */
	public WorkloadStoragePlanetLabWrite(String inputPath, double schedulingInterval)
	 ...
	 * @throws IOException Signals that an I/O exception has occurred.
	 */
	public WorkloadStoragePlanetLabWrite(String inputPath, double schedulingInterval, int dataSamples)
			throws NumberFormatException,
			IOException {
		setSchedulingInterval(schedulingInterval);
